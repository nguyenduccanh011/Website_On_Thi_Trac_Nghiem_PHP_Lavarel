...
@section('title', 'Chỉnh sửa ngân hàng đề thi')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Chỉnh sửa ngân hàng đề thi</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.exam-banks.update', $examBank) }}" method="POST" id="examBankForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('is_active') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ $examBank->is_active == 1 ? 'selected' : '' }}>Kích hoạt</option>
                                        <option value="0" {{ $examBank->is_active == 0 ? 'selected' : '' }}>Vô hiệu hóa</option>
                                    </select>
                                    @error('is_active')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="selectedQuestionsTable">
                                        ...
                                        <tbody>
                                            @foreach($examBank->questions as $question)
                        ...
                        <div class="text-end mt-3">
                            <button type="submit" class="btn btn-primary">Cập nhật ngân hàng đề thi</button>
                        </div>
                    </form>
                </div>
            </div>
